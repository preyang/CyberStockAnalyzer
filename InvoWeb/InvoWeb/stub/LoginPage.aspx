...
<body>
   <div class="main">
     <!--header start -->
        <div class="header">
            ...
            <div class="logo"><h1><span>Invo</span>WebStub<br /></h1></div>
            <div class="clr"></div>
            </div>
        </div>
    <!--header end -->
   ...
   <div class="content">
        ...
        <asp:Login ID="Login1" runat="server" RememberMeSet="True" >
            ...
            <label for="password">Password :&nbsp;<a href="#" tabindex="2">(Forgot Your Password?)</a></label>
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf">Invoice System by <a href="#">InvoWebStub</a></p>
      <ul class="fmenu">
