...
<td>
    <asp:TextBox ID="txtEmailId" runat="server" CssClass="text" 
        AutoPostBack="True" ></asp:TextBox>
    <br />
    <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" 
        ErrorMessage="Email ID already exist..." ForeColor="Red" 
        onservervalidate="CustomValidator1_ServerValidate"></asp:CustomValidator>
</td>
<td>
    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
        ErrorMessage="Please Enter Valid Email-Id" ControlToValidate="txtEmailId" 
...
<td>
    <asp:CompareValidator ID="CompareValidator1" runat="server" 
        ErrorMessage="Your Password Does No Match!!" 
...
<td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
        ...
        InitialValue="Select Any Question"></asp:RequiredFieldValidator>
...
<td> &nbsp;</td>
<td>
    <asp:Button ID="btnSubmit" runat="server" Text="Registered & Next" 
...
<td>
    <asp:Label ID="lblInvoiceNoPrefix" runat="server" Text="Invoice No Prefix :"></asp:Label>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
        ErrorMessage="*" ControlToValidate="txtInvoiceNoPrefix" 
        ForeColor="Red" ValidationGroup="s"></asp:RequiredFieldValidator><br />
</td>
<td>
    <asp:TextBox ID="txtInvoiceNoPrefix" runat="server" CssClass="text" 
        ValidationGroup="s"></asp:TextBox><br /> example. "IWS" for InvoiceNo-"IWS00002". 
</td>
<td><asp:RegularExpressionValidator ID="RegularExpressionValidator4"
        runat="server" ErrorMessage="Maximum 3 character string." 
        ValidationExpression="^[a-zA-Z]{3,3}$" ControlToValidate="txtInvoiceNoPrefix" 
        ForeColor="Red"></asp:RegularExpressionValidator><br /></td>
</tr>
...
<td>
    <asp:Label ID="lblCompAddress" runat="server" Text="Company Address"></asp:Label>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" 
        ErrorMessage="*" ControlToValidate="txtCompAddress" 
        ForeColor="Red" ValidationGroup="s"></asp:RequiredFieldValidator>
     <br /><br /><br /><br />
</td>
<td>
    <asp:TextBox ID="txtCompAddress" runat="server" CssClass="text" 
        TextMode="MultiLine" ValidationGroup="s"></asp:TextBox>
</td>
<td>&nbsp;</td>
</tr>
...
<td>
    <asp:Label ID="lblCompLogo" runat="server" Text="Company Logo"></asp:Label>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
        ErrorMessage="*" ControlToValidate="logoUpload" 
        ForeColor="Red" ValidationGroup="s"></asp:RequiredFieldValidator><br />
</td>
...
<td>
    <asp:TextBox ID="txtContactPerson" runat="server" CssClass="text" 
        ValidationGroup="s"></asp:TextBox>
</td>
<td>&nbsp;</td>
</tr>
...
<td>
    <asp:TextBox ID="txtContactNo" runat="server" CssClass="text" 
        ValidationGroup="s"></asp:TextBox>
</td>
<td>
    &nbsp;</td>
...
<td>
    <asp:TextBox ID="txtContactEmail" runat="server" CssClass="text" 
        ValidationGroup="s"></asp:TextBox>
</td>
<td>
...
<td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" 
        ControlToValidate="txtWebsite" ErrorMessage="*" ForeColor="Red" 
...
<td>
   <asp:Button ID="SavecompMaster" runat="server" Text="Save Company" 
        CssClass="submit" onclick="SavecompMaster_Click" ValidationGroup="s"  />
</td>
</tr>
</table>
