...
<h2>Daily Sales Performance</h2>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT CreatedDate, SUM(NetAmount) AS TotalAmount FROM InvoiceMaster WHERE (CreatedDate BETWEEN DATEADD(day, - 5, GETDATE()) AND GETDATE()) GROUP BY CreatedDate ORDER BY CreatedDate" 
        >
    </asp:SqlDataSource>
    </td>
    <td align="center" width="50%">
